...
void addTask(Task task) {
  _tasksDatabaseConnection.doc(task.id).set(task.toJson())
...
Stream<QuerySnapshot> getAllTasks() {
  return _tasksDatabaseConnection.snapshots().handleError((dynamic e) => print('ERROR: could get tasks from FireStore'));
}
